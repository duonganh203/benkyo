...
export const AIQuizModal = ({ open, onOpenChange, onSubmit, classId }: AIQuizModalProps) => {
    ...
    const { mutateAsync: createQuiz } = useCreateClassQuiz();
    ...
    const generateQuiz = async () => {
        ...
        try {
            ...
            console.log('Questions:', savedQuiz.questions);

            if (!savedQuiz.questions || !Array.isArray(savedQuiz.questions)) {
                throw new Error('Quiz was created but no questions were returned.');
            }

            onSubmit({
                title: savedQuiz.title || 'AI Generated Quiz',
                description: savedQuiz.description || '',
                classId: savedQuiz.class,
                deck: savedQuiz.deck || '',
