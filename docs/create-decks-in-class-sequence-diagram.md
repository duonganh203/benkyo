# Create Decks In Class - Sequence Diagram
...
sequenceDiagram
    ...
    User->>UI: 1. Click Add Deck to Class button
    ...
    alt 3.1. Authentication failed
        ...
        alt 8.1. Class not found
            ...
            Service->>Data: 9. Deck.find() - Get available decks (owned or approved)
            Data-->>Service: 10. Return available decks list
            Service-->>Controller: 11. Return available decks
            Controller-->>UI: 12. Return 200 OK with decks
            UI->>UI: 13. Show deck selection modal
            UI-->>User: 14. Display available decks

            User->>UI: 15. Select deck and fill schedule (startTime, endTime, description)
            UI->>UI: 16. Validate form data

            alt 16.1. Validation failed
                UI-->>User: 16.1.1. Show validation errors
            else 16.2. Validation success
                ...
                alt 18.1. Authentication failed
                    ...
                    Controller->>Service: 21. addDeckToClassService(classId, deckId, data, userId)
                    ...
                    alt 23.1. Class not found
                        ...
                        alt 24.1. Not owner
                            ...
                            alt 26.1. Deck not found
                                ...
                                Service->>Service: 27. Check deck permission (approved or owned)
                                ...
                                alt 27.1. Not approved and not owned
                                    ...
                                    Service->>Service: 28. Check if deck already in class

                                    alt 28.1. Deck already exists
                                        ...
                                        alt 29.1. Invalid time range
                                            ...
                                            Service->>Data: 30. Class.updateOne() - Add deck to class.decks
                                            ...
                                            UI-->>User: 35. Show success message
                                        end
                                    end
                                end
                            end
